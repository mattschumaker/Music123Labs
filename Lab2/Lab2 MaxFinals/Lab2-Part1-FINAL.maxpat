...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 543.58349609375, 433.800018310546875, 22.799997329711914, 20.0 ],
					"text" : "10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.600006103515625, 431.800018310546875, 50.0, 22.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.79998779296875, 465.600006103515625, 50.0, 22.0 ],
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 432.516815185546875, 504.800018310546875, 50.399997711181641, 22.0 ],
					"text" : "line~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 634.4000244140625, 22.799997329711914, 20.0 ],
					"text" : "13"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 175.0, 634.4000244140625, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 584.0, 22.799997329711914, 20.0 ],
					"text" : "12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 175.0, 584.0, 100.0, 22.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.583465576171875, 465.600006103515625, 22.799997329711914, 20.0 ],
					"text" : "11"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.91680908203125, 390.600006103515625, 22.799997329711914, 20.0 ],
					"text" : "9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 432.0, 390.600006103515625, 50.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.516815185546875, 276.800018310546875, 22.799997329711914, 20.0 ],
					"text" : "8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 175.0, 541.60003662109375, 276.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 541.60003662109375, 22.799997329711914, 20.0 ],
					"text" : "7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 495.20001220703125, 22.799997329711914, 20.0 ],
					"text" : "6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 451.600006103515625, 22.799997329711914, 20.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 403.20001220703125, 22.799997329711914, 20.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 334.800018310546875, 22.799997329711914, 20.0 ],
					"text" : "3)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 276.800018310546875, 22.799997329711914, 20.0 ],
					"text" : "2)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.399993896484375, 178.20001220703125, 22.799997329711914, 20.0 ],
					"text" : "1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 612.20001220703125, 103.599998474121094, 705.0, 961.0 ],
					"text" : "In lab 2, part 1, we look at midi note messages and ADSR envelopes.\n\nCreate the patch in your instructions here.\n\n1) Open the demo patch provide.  It comes with code within a subpatch labelled midikey_note. Subpatches are an important means to encapsulate and abstract away some of the complexity of your Max programs. This code takes the keystrokes from the lowest two rows of your keyboard and translates them into midi keyboard notes. See the keyboard to note matching on the diagram by the side of this subpatch.  \n\nMidi noteon events include two numbers: the midipitch and the velocity. Midipitch defines the pitch and midivelocity defines the loudness of the midievent. Both midipitch and midivelocity have values ranging between 1-127.\n\nMidi noteoff events occur when we lift our fingers off the keyboard and indicate when the note event is over.  midi note off events have the same midipitch but with a midivelocity value of 0.\n\n2) In order to synthesize our notes, we want to separate the midipitch from the midivelocity. We can us unpack to do this.  Unpack breaks up a list into its elements.  We need to set those elemets in the arguments that we use for unpack. In this case, the two arguments are integers, which we shorten as \"i\".  In the object, we type \"unpack i i\" to create the unpack object that expects to break the incoming message into two integers for midipitch and midivelocity.\n\n3) The octave adjust subpatch code allows us to transpose the midipitch up and down an octave.  You can look inside if you want to know how it works.\n\n4)  After this, we create a number box \"i\" that will display our midipitch. \n\n5) We need to translate our midipitch to frequency (Hz) for our oscillator. The mtof (midi-to-frequency) object does that for us. \n\n6) After that, we can plug the frequency into our VCO (voltage-controlled oscillator). Let's use a triangle waveform here, using the tri~ object.\n\n7) The output of this the continuous audio from the tri~ object at the frequency we set.  Now we need to control the loudness of this sound with our VCA (voltage-controlled amplifier). Again, we'll use the *~ object to do this.\n\n8) At this point, it would be good to use the midi velocity portion of our original note event message to control the amplitude of our output sound.  We get the velocity from the second outlet of our pack object (2).  In this patch, the velocity is set at 90 because we can't detect the velocity that you hit your keyboard with, but, generally, this value would reflect that for any midi instrument that you use.\n\n9) We need to convert the midivelocity into an amplitude scalar value that makes sense for our instrument. When discussing amplitude, we generally scale between 0.- 1. In order to scale in this way, we can simply divide the midivelocity by the 127, which is the loudest possible midivelocity value. So we'll use the \"/\" max object with the argument of 127..  BE SURE TO USE A FLOAT NUMBER IN YOUR DIVIDE OBJECT OR ELSE YOU WILL NOT RECEIVE THE FLOATING POINT VALUES YOU NEED HERE. The \".\" is very important as part of the \"127.\" argument because it tells Max to be sure to make floating point calculations.  Otherwise, Max will revert to integer calculations by default.\n\n10) We can create a message box to confirm this translation from midivelocity to amplitude scalar. Patch into the right inlet to see the values. \n\n11) We can smooth the amplitude changes as before, using the line~ object in conjunction with message \"$1 20,\" which ramps to the new amplitude value over 20 milliseconds. Then we will plug the result into the right inlet of our *~ object as the amplitude scalar that we use to scale the loudness of the signal from our oscillator\n\n12) After this, we create another *~ object to scale our amplitudes back further.  As before, we set a value of 0.2 as an initiialing argument to ensure that our output signal is not too loud.\n\n13) Then we are ready to send the result out of our computer through the speakers using the digital to audio conversion of the EZDAC~ object."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "LAB 2, PART 1: Midi note events"
				}
